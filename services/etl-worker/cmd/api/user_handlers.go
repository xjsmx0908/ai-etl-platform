...
// contract rather than fix a bug. A floor is a product policy, and there is no
// product policy on this path -- auth.ValidatePasswordStorage checks only what
// the storage format cannot represent.
