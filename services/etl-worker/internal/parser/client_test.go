...
func TestParseFile_UsesInternalTokenFromFile(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte(`{"doc_id":"d1","tenant_id":"t1","chunks":[{"chunk_id":"d1_0","doc_id":"d1","tenant_id":"t1","content":"hello","index":0}],"total_chunks":1,"parse_time_ms":1.2,"file_size_bytes":12,"status":"success"}`))
	}))
	defer srv.Close()
