...
| P-UAT-2 | 受管换版切块未切换 | open | 复现 UAT-014：替换后清理旧切块或按 version 过滤检索，使问答切到新内容 | [`../issues/findings-register.md`](../issues/findings-register.md) |
...
续跑入口已关闭：UAT-013 完成。2026-09-09-gap 覆盖补测后开放 UAT-014 / P-UAT-2，不重跑 D0–D4。
