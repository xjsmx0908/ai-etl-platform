...
| P-CAP-2 | 真实模型 RAG 质量 | done | 演示栈 `--api-base` retrieval-only：有效 60 题 Recall@5 97.8% 达到 90%；压零重叠长文档后 Recall@1 62%→71%。不作为 P1.9 签字 Gold | [`evals/README.md`](evals/README.md) |
