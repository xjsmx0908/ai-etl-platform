...
> **修订说明（2026-09-22；2026-09-23 补第十七至二十处，同日完成全文一致性审计并修掉 7 处漂移，见 §8 末条）**：初稿结论是「风险不在功能，在运维底座」。随后在部署环境上做了逐条复现的
...
- **代码改动集中在这些章节**：§1.3 列出的 20 个缺陷，§1.1.2 的 ES 水位百分比化 + 宿主机磁盘告警
