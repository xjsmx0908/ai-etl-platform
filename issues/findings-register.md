...
| UAT-010 | 功能缺陷 | S1 | `/qa` | readonly | 开放 | 只读用户无法问答列表中已发布的公开文档 | 本轮发现：只读可见「赴港流程」但问答拒答，且无知识空间可选 |
...
2026-09-09 已完成 D1 复验。旧九条不再处于「待复验」。开放项为 UAT-007、UAT-010～013。S1 仅 UAT-010，已回写 backlog。
